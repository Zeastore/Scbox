...
wget -q -O /usr/bin/add-l2tp https://raw.githubusercontent.com/tridebleng/Scbox/main/ipsec/add-l2tp.sh && chmod +x /usr/bin/add-l2tp
wget -q -O /usr/bin/del-l2tp https://raw.githubusercontent.com/tridebleng/Scbox/main/ipsec/del-l2tp.sh && chmod +x /usr/bin/del-l2tp
wget -q -O /usr/bin/add-pptp https://raw.githubusercontent.com/tridebleng/Scbox/main/ipsec/add-pptp.sh && chmod +x /usr/bin/add-pptp
wget -q -O /usr/bin/del-pptp https://raw.githubusercontent.com/tridebleng/Scbox/main/ipsec/del-pptp.sh && chmod +x /usr/bin/del-pptp
wget -q -O /usr/bin/renew-pptp https://raw.githubusercontent.com/tridebleng/Scbox/main/ipsec/renew-pptp.sh && chmod +x /usr/bin/renew-pptp
wget -q -O /usr/bin/renew-l2tp https://raw.githubusercontent.com/tridebleng/Scbox/main/ipsec/renew-l2tp.sh && chmod +x /usr/bin/renew-l2tp
wget -q -O /usr/bin/trial-pptp https://raw.githubusercontent.com/tridebleng/Scbox/main/ipsec/trial-pptp.sh && chmod +x /usr/bin/trial-pptp
wget -q -O /usr/bin/trial-l2tp https://raw.githubusercontent.com/tridebleng/Scbox/main/ipsec/trial-l2tp.sh && chmod +x /usr/bin/trial-l2tp

touch /var/lib/scrz-prem/data-user-l2tp > /dev/null 2>&1
touch /var/lib/scrz-prem/data-user-pptp > /dev/null 2>&1

wget -q -O /usr/bin/ipsec-menu "https://raw.githubusercontent.com/tridebleng/Scbox/main/menu_all/ipsec-menu.sh" && chmod +x /usr/bin/ipsec-menu
