...
MYIP=$(curl -sS ipv4.icanhazip.com)
NameUser=$(curl -sS https://raw.githubusercontent.com/Zeastore/Scbox/main/ip | grep $MYIP | awk '{print $2}')
...
LLatest=`date`
Get_Data () {
git clone https://github.com/Zeastore/Scbox.git /root/user-backup/ &> /dev/null
}
...
Save_And_Exit () {
    ...
    git remote add origin https://github.com/Zeastore/Scbox
...
link="https://raw.githubusercontent.com/Zeastore/Scbox/main/$NameUser/$NameUser.zip"
sleep 1
