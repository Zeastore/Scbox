...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/tridebleng/Scbox/main/skkkk > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/tridebleng/Scbox/main/skkkk | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/tridebleng/Scbox/main/skkkk | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
echo -e "\E[0;41;36m                AUTOREBOOT                \E[0m"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"  
echo -e "
${green}Example :${NC}
0     = 12 PM
