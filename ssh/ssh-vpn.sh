...
<font color="white"><b>         HUMANITY         </b></font><br> 
...
# download script
wget -q -O /usr/bin/usernew "https://raw.githubusercontent.com/Zeastore/Scbox/main/ssh/usernew.sh" && chmod +x /usr/bin/usernew
wget -q -O /usr/bin/trial "https://raw.githubusercontent.com/Zeastore/Scbox/main/ssh/trial.sh" && chmod +x /usr/bin/trial
wget -q -O /usr/bin/hapus "https://raw.githubusercontent.com/Zeastore/Scbox/main/ssh/hapus.sh" && chmod +x /usr/bin/hapus
wget -q -O /usr/bin/member "https://raw.githubusercontent.com/Zeastore/Scbox/main/ssh/member.sh" && chmod +x /usr/bin/member
wget -q -O /usr/bin/delete "https://raw.githubusercontent.com/Zeastore/Scbox/main/ssh/delete.sh" && chmod +x /usr/bin/delete
wget -q -O /usr/bin/cek "https://raw.githubusercontent.com/Zeastore/Scbox/main/ssh/cek.sh" && chmod +x /usr/bin/cek
wget -q -O /usr/bin/restart "https://raw.githubusercontent.com/Zeastore/Scbox/main/ssh/restart.sh" && chmod +x /usr/bin/restart
wget -q -O /usr/bin/renew "https://raw.githubusercontent.com/Zeastore/Scbox/main/ssh/renew.sh" && chmod +x /usr/bin/renew
wget -q -O /usr/bin/autokill "https://raw.githubusercontent.com/Zeastore/Scbox/main/ssh/autokill.sh" && chmod +x /usr/bin/autokill
wget -q -O /usr/bin/ceklim "https://raw.githubusercontent.com/Zeastore/Scbox/main/ssh/ceklim.sh" && chmod +x /usr/bin/ceklim
wget -q -O /usr/bin/tendang "https://raw.githubusercontent.com/Zeastore/Scbox/main/ssh/tendang.sh" && chmod +x /usr/bin/tendang
wget -q -O /usr/bin/port-dropbear "https://raw.githubusercontent.com/Zeastore/Scbox/main/ssh/port-dropbear.sh" && chmod +x /usr/bin/port-dropbear
#wget -q -O /usr/bin/port-ovpn "https://raw.githubusercontent.com/Zeastore/Scbox/main/ssh/port-ovpn.sh" && chmod +x /usr/bin/port-ovpn
wget -q -O /usr/bin/port-ssl "https://raw.githubusercontent.com/Zeastore/Scbox/main/ssh/port-ssl.sh" && chmod +x /usr/bin/port-ssl
wget -q -O /usr/bin/banner "https://raw.githubusercontent.com/Zeastore/Scbox/main/banner/banner.sh" && chmod +x /usr/bin/banner
wget -q -O /usr/bin/sshws "https://raw.githubusercontent.com/Zeastore/Scbox/main/ssh/ins-sshws.sh" && chmod +x /usr/bin/sshws
wget -q -O /usr/bin/ssh-menu "https://raw.githubusercontent.com/Zeastore/Scbox/main/menu_all/ssh-menu.sh" && chmod +x /usr/bin/ssh-menu
wget -q -O /usr/bin/port-wssl "https://raw.githubusercontent.com/Zeastore/Scbox/main/ssh/port-ws-ssl.sh" && chmod +x /usr/bin/port-wssl
wget -q -O /usr/bin/asu "https://raw.githubusercontent.com/Zeastore/Scbox/main/ssh/asu.sh" && chmod +x /usr/bin/asu
