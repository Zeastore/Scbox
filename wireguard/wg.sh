...
wget -q -O /usr/bin/add-wg "https://raw.githubusercontent.com/tridebleng/Scbox/main/wireguard/add-wg.sh" && chmod +x /usr/bin/add-wg
wget -q -O /usr/bin/del-wg "https://raw.githubusercontent.com/tridebleng/Scbox/main/wireguard/del-wg.sh" && chmod +x /usr/bin/del-wg
wget -q -O /usr/bin/cek-wg "https://raw.githubusercontent.com/tridebleng/Scbox/main/wireguard/cek-wg.sh" && chmod +x /usr/bin/cek-wg
wget -q -O /usr/bin/renew-wg "https://raw.githubusercontent.com/tridebleng/Scbox/main/wireguard/renew-wg.sh" && chmod +x /usr/bin/renew-wg
wget -q -O /usr/bin/trial-wg "https://raw.githubusercontent.com/tridebleng/Scbox/main/wireguard/trial-wg.sh" && chmod +x /usr/bin/trial-wg
wget -q -O /usr/bin/port-wg "https://raw.githubusercontent.com/tridebleng/Scbox/main/wireguard/port-wg.sh" && chmod +x /usr/bin/port-wg

wget -q -O /usr/bin/wg-menu "https://raw.githubusercontent.com/tridebleng/Scbox/main/menu_all/wg-menu.sh" && chmod +x /usr/bin/wg-menu
