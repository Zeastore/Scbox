...
wget -q -O /usr/bin/addxtls "https://bhm-vpn.com/asu/xray/add.sh" && chmod +x /usr/bin/addxtls
wget -q -O /usr/bin/delxtls "https://bhm-vpn.com/asu/xray/del.sh" && chmod +x /usr/bin/delxtls
wget -q -O /usr/bin/cekxtls "https://bhm-vpn.com/asu/xray/chk.sh" && chmod +x /usr/bin/cekxtls
wget -q -O /usr/bin/renewxtls "https://bhm-vpn.com/asu/xray/rnw.sh" && chmod +x /usr/bin/renewxtls
wget -q -O /usr/bin/portxtls "https://bhm-vpn.com/asu/xray/pxt.sh" && chmod +x /usr/bin/portxtls
