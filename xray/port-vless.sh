...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/Zeastore/test/main/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/Zeastore/test/main/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/Zeastore/test/main/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
echo -e "\\E[0;41;36m         Change Port Vless         \E[0m"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e ""
